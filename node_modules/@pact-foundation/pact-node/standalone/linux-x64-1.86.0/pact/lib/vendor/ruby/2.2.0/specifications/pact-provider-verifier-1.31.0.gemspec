# -*- encoding: utf-8 -*-
# stub: pact-provider-verifier 1.31.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<pact>.freeze, ["~> 1.49"])
      s.add_runtime_dependency(%q<pact-message>.freeze, ["~> 0.5"])
      s.add_runtime_dependency(%q<faraday>.freeze, ["~> 0.9", ">= 0.9.0"])
      ...
      s.add_dependency(%q<pact>.freeze, ["~> 1.49"])
      s.add_dependency(%q<pact-message>.freeze, ["~> 0.5"])
      s.add_dependency(%q<faraday>.freeze, ["~> 0.9", ">= 0.9.0"])
